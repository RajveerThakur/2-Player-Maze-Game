...
def options():
    ...
    while running:
        ...
        maze_colors = [
            ((227, 19, 29), pg.Rect(325, 175, 75, 75)),
            ((255, 217, 102), pg.Rect(450, 175, 75, 75)),
            ((56, 118, 29), pg.Rect(575, 175, 75, 75)),
            ((96, 193, 232), pg.Rect(700, 175, 75, 75)),
            ((24, 37, 71), pg.Rect(825, 175, 75, 75)),
            ((250, 81, 146), pg.Rect(950, 175, 75, 75)),
            ((91, 107, 170), pg.Rect(1075, 175, 75, 75))
        ]
        
        wall_colors = [
            ((0, 0, 0), pg.Rect(325, 475, 75, 75)),
            ((255, 255, 255), pg.Rect(450, 475, 75, 75)),
            ((204, 204, 204), pg.Rect(575, 475, 75, 75)),
            ((249, 203, 156), pg.Rect(700, 475, 75, 75)),
            ((255, 217, 102), pg.Rect(825, 475, 75, 75)),
            ((96, 193, 232), pg.Rect(950, 475, 75, 75)),
            ((174, 73, 73), pg.Rect(1075, 475, 75, 75))
        ]
